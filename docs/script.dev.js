...
document.addEventListener("DOMContentLoaded", function () {
  // Variables
  var newTaskText = document.querySelector("#newTaskInput");
  var addNewTaskBtn = document.querySelector("#btn__addNewTask");
  var taskListUl = document.querySelector(".taskList__ul");
  ...
  function checkInput() {
    var content = newTaskText.value.trim();
  ...
  function addTask(content) {
    ...
    taskListUl.appendChild(taskItem); // complete the task

    taskItemIconsCheck.onclick = function () {
    ...
    taskItemIconsTrash.onclick = function () {
